...
#define STRING_CONFIG_H_AUTHOR "(Solid Snake, Ender 5 SkrV1.4Turbo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "GenderBender3Dprinter"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // 4mm borosilicate (Ender 5 with Borosilicate Glassbed, insulated on the bottom.)
  #define DEFAULT_bedKp 115.25
  #define DEFAULT_bedKi 22.78
  #define DEFAULT_bedKd 388.76
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 134 }
